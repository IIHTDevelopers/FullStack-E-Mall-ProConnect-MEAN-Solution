...
describe("Order Controller", () => {
  describe("boundary", () => {
    ...
    it(`${orderControllerBoundaryTest} should create a new order`, async () => {
      ...
      expect(OrderServiceImpl.prototype.createOrder).toHaveBeenCalledWith(
        mReq.body
      );
    ...
    it(`${orderControllerBoundaryTest} should update an order by ID`, async () => {
      ...
      OrderServiceImpl.prototype.updateOrder.mockResolvedValueOnce(
        updatedOrder
      );

      await new OrderController().updateOrder(mReq, mRes, mNext);

      expect(OrderServiceImpl.prototype.updateOrder).toHaveBeenCalledWith(
        orderId,
        updatedOrderData
      );
    ...
    it(`${orderControllerBoundaryTest} should delete an order by ID`, async () => {
      ...
      OrderServiceImpl.prototype.deleteOrder.mockResolvedValueOnce(
        deletedOrder
      );

      await new OrderController().deleteOrder(mReq, mRes, mNext);

      expect(OrderServiceImpl.prototype.deleteOrder).toHaveBeenCalledWith(
        orderId
      );
    ...
    it(`${orderControllerBoundaryTest} should return a 404 error when getting an order with invalid ID`, async () => {
      ...
      OrderServiceImpl.prototype.getOrder.mockRejectedValueOnce(
    ...
    it(`${orderControllerBoundaryTest} should return a 404 error when updating an order with invalid ID`, async () => {
      ...
      OrderServiceImpl.prototype.updateOrder.mockRejectedValueOnce(
        new Error("Order not found.")
      );
    ...
    it(`${orderControllerBoundaryTest} should return a 404 error when deleting an order with invalid ID`, async () => {
      ...
      OrderServiceImpl.prototype.deleteOrder.mockRejectedValueOnce(
        new Error("Order not found.")
      );
    ...
    it(`${orderControllerBoundaryTest} should retrieve user's orders by user ID`, async () => {
      ...
      OrderServiceImpl.prototype.getUserOrders.mockResolvedValueOnce(
        mockUserOrders
      );

      await new OrderController().getUserOrders(mReq, mRes, mNext);

      expect(OrderServiceImpl.prototype.getUserOrders).toHaveBeenCalledWith(
        userId
      );
    ...
    it(`${orderControllerBoundaryTest} should cancel an order by ID`, async () => {
      ...
      OrderServiceImpl.prototype.cancelOrder.mockResolvedValueOnce(
        canceledOrder
      );

      await new OrderController().cancelOrder(mReq, mRes, mNext);

      expect(OrderServiceImpl.prototype.cancelOrder).toHaveBeenCalledWith(
        orderId
      );
    ...
    it(`${orderControllerBoundaryTest} should retrieve payment details for an order by ID`, async () => {
      ...
      OrderServiceImpl.prototype.retrievePaymentDetails.mockResolvedValueOnce(
        paymentDetails
      );
      ...
      expect(
        OrderServiceImpl.prototype.retrievePaymentDetails
    ...
    it(`${orderControllerBoundaryTest} should process payment for an order by ID`, async () => {
      ...
      expect(OrderServiceImpl.prototype.processPayment).toHaveBeenCalledWith(
        orderId
      );
      expect(mRes.json).toHaveBeenCalledWith({
    ...
    it(`${orderControllerBoundaryTest} should retrieve order analytics`, async () => {
      ...
      OrderServiceImpl.prototype.getOrderAnalytics.mockResolvedValueOnce(
        orderAnalytics
      );
    ...
    it(`${orderControllerBoundaryTest} should generate an invoice for an order by ID`, async () => {
      ...
      expect(OrderServiceImpl.prototype.generateInvoice).toHaveBeenCalledWith(
        orderId
      );
    ...
    it(`${orderControllerBoundaryTest} should track shipment for an order by ID`, async () => {
      ...
      OrderServiceImpl.prototype.trackShipment.mockResolvedValueOnce(
        shipmentDetails
      );

      await new OrderController().trackShipment(mReq, mRes, mNext);

      expect(OrderServiceImpl.prototype.trackShipment).toHaveBeenCalledWith(
        orderId
      );
    ...
    it(`${orderControllerBoundaryTest} should retrieve revenue analytics`, async () => {
      ...
      OrderServiceImpl.prototype.getRevenueAnalytics.mockResolvedValueOnce(
        revenueAnalytics
      );
