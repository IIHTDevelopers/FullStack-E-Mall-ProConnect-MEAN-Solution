...
describe("Product Controller", () => {
  describe("boundary", () => {
    ...
    it(`${productControllerBoundaryTest} should create a new product`, async () => {
      ...
      ProductServiceImpl.prototype.createProduct.mockResolvedValueOnce(
        mockProduct
      );

      await new ProductController().createProduct(mReq, mRes, mNext);

      expect(ProductServiceImpl.prototype.createProduct).toHaveBeenCalledWith(
        mReq.body
      );
    ...
    it(`${productControllerBoundaryTest} should retrieve a product by ID`, async () => {
      ...
      ProductServiceImpl.prototype.getProduct.mockResolvedValueOnce(
        mockProduct
      );

      await new ProductController().getProduct(mReq, mRes, mNext);

      expect(ProductServiceImpl.prototype.getProduct).toHaveBeenCalledWith(
        productId
      );
      expect(mRes.json).toHaveBeenCalledWith(mockProduct);
      expect(mNext).not.toHaveBeenCalled();
    ...
    it(`${productControllerBoundaryTest} should update a product by ID`, async () => {
      ...
      ProductServiceImpl.prototype.updateProduct.mockResolvedValueOnce(
        updatedProduct
      );

      await new ProductController().updateProduct(mReq, mRes, mNext);

      expect(ProductServiceImpl.prototype.updateProduct).toHaveBeenCalledWith(
        productId,
        updatedProductData
      );
    ...
    it(`${productControllerBoundaryTest} should return a 404 error when getting product with invalid ID`, async () => {
      ...
      ProductServiceImpl.prototype.getProduct.mockRejectedValueOnce(
    ...
    it(`${productControllerBoundaryTest} should return a 404 error when updating product with invalid ID`, async () => {
      ...
      ProductServiceImpl.prototype.updateProduct.mockRejectedValueOnce(
        new Error("Product not found.")
      );
    ...
    it(`${productControllerBoundaryTest} should return a 404 error when deleting product with invalid ID`, async () => {
      ...
      ProductServiceImpl.prototype.deleteProduct.mockRejectedValueOnce(
        new Error("Product not found.")
      );
    ...
    it(`${productControllerBoundaryTest} should retrieve all products`, async () => {
      ...
      ProductServiceImpl.prototype.getAllProducts.mockResolvedValueOnce(
        mockProducts
      );
    ...
    it(`${productControllerBoundaryTest} should handle error when retrieving all products`, async () => {
      ...
      ProductServiceImpl.prototype.getAllProducts.mockRejectedValueOnce(
    ...
    it(`${productControllerBoundaryTest} should retrieve top rated products`, async () => {
      ...
      ProductServiceImpl.prototype.getTopRatedProducts.mockResolvedValueOnce(
      ...
      expect(
        ProductServiceImpl.prototype.getTopRatedProducts
    ...
    it(`${productControllerBoundaryTest} should handle error when retrieving top rated products`, async () => {
      ...
      ProductServiceImpl.prototype.getTopRatedProducts.mockRejectedValueOnce(
        new Error("Failed to retrieve top rated products.")
      );
      ...
      expect(mRes.status).toHaveBeenCalledWith(500);
      expect(mRes.json).toHaveBeenCalledWith({
        error: "Failed to retrieve top rated products.",
      });
      expect(mNext).not.toHaveBeenCalled();
    });
    ...
    it(`${productControllerBoundaryTest} should search for products by name and description`, async () => {
      ...
      ProductServiceImpl.prototype.searchProduct.mockResolvedValueOnce(
        mockSearchResults
      );

      await new ProductController().searchProduct(mReq, mRes, mNext);

      expect(ProductServiceImpl.prototype.searchProduct).toHaveBeenCalledWith(
        "Product",
        "Test"
      );
    ...
    it(`${productControllerBoundaryTest} should handle error when searching for products`, async () => {
      ...
      ProductServiceImpl.prototype.searchProduct.mockRejectedValueOnce(
    ...
    it(`${productControllerBoundaryTest} should apply a discount to the cart`, async () => {
      ...
      ProductServiceImpl.prototype.applyDiscount.mockResolvedValueOnce(
        mockResult
      );

      await new ProductController().applyDiscount(mReq, mRes, mNext);

      expect(ProductServiceImpl.prototype.applyDiscount).toHaveBeenCalledWith(
        userId,
        discountPercentage
      );
    ...
    it(`${productControllerBoundaryTest} should handle error when applying a discount`, async () => {
      ...
      ProductServiceImpl.prototype.applyDiscount.mockRejectedValueOnce(
        new Error("Failed to apply discount.")
      );
    ...
    it(`${productControllerBoundaryTest} should view the cart for a user`, async () => {
      ...
      expect(ProductServiceImpl.prototype.viewCart).toHaveBeenCalledWith(
        userId
      );
    ...
    it(`${productControllerBoundaryTest} should handle error when viewing the cart`, async () => {
      ...
      ProductServiceImpl.prototype.viewCart.mockRejectedValueOnce(
        new Error("Failed to view cart.")
      );
    ...
    it(`${productControllerBoundaryTest} should update a cart item for a user`, async () => {
      ...
      ProductServiceImpl.prototype.updateCartItem.mockResolvedValueOnce(
        mockResult
      );

      await new ProductController().updateCartItem(mReq, mRes, mNext);

      expect(ProductServiceImpl.prototype.updateCartItem).toHaveBeenCalledWith(
        userId,
        itemId,
        quantity
      );
    ...
    it(`${productControllerBoundaryTest} should handle error when updating a cart item`, async () => {
      ...
      ProductServiceImpl.prototype.updateCartItem.mockRejectedValueOnce(
    ...
    it(`${productControllerBoundaryTest} should remove a cart item for a user`, async () => {
      ...
      ProductServiceImpl.prototype.removeCartItem.mockResolvedValueOnce(
        mockResult
      );

      await new ProductController().removeCartItem(mReq, mRes, mNext);

      expect(ProductServiceImpl.prototype.removeCartItem).toHaveBeenCalledWith(
        userId,
        itemId
      );
      expect(mRes.json).toHaveBeenCalledWith(mockResult);
    ...
    it(`${productControllerBoundaryTest} should handle error when removing a cart item`, async () => {
      ...
      ProductServiceImpl.prototype.removeCartItem.mockRejectedValueOnce(
